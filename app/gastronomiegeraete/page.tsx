...
import { gastroFaqs } from "@/lib/gastronomieFaq";
...
const heroImage = {
  ...
  alt: "Gastronomieküche mit Gewerbespülmaschine, Kühltheke, Gastroherd und Siebträgermaschine im gewerblichen Einsatz",
};

const title = "Gastronomiegeräte Reparatur Berlin – Notdienst für Betriebe";
const description = `Reparatur von Gastronomiegeräten in Berlin und Umland, rund um die Uhr – für Küche, Theke und Betrieb. Anfahrt inklusive Kostenvoranschlag für nur ${business.calloutFee} € – ohne Zuschlag an Wochenenden und Feiertagen. Dazu ${gastroFaqs.length} häufige Fragen und Antworten rund um Gastronomiegeräte.`;
...
export default function LeistungenPage() {
  ...
  const serviceSchema = {
    ...
    "@type": "Service",
    name: "Gastronomiegeräte Reparatur Notdienst Berlin",
    description,
    url: pageUrl,
    serviceType: "Gastronomiegeräte Reparatur",
    provider: {
      "@type": "LocalBusiness",
      name: business.name,
      url: siteUrl,
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Gastronomiegeräte Reparatur", item: pageUrl },
    ],
  };
  ...
  return (
    <>
      ...
      <main className="page-shell">
        <section className="hero hero--diagram" id="notdienst" aria-labelledby="gastronomiegeraete-heading">
          <svg
          ...
          <div className="hero-inner">
            <div className="hero-content">
              <p className="hero-kicker">Gastronomiegeräte · Berlin &amp; Umland</p>
              <AnimatedPageTitle
                id="gastronomiegeraete-heading"
                parts={[
                  { text: "Gastronomiegeräte " },
                  { text: "Reparatur im Notdienst", emphasized: true },
                ]}
              />
              <p className="hero-description">
                Spülmaschine, Kühltheke, Fritteuse oder Siebträger streiken mitten im Service? Wir kommen
                als Notdienst in Ihren Betrieb – auf Wunsch auch außerhalb Ihrer Öffnungszeiten, damit
        ...
        <div className="device-faq-layout device-faq-layout--with-why device-faq-layout--rail-match">
          ...
          <div className="device-faq-column">
            <WhyChooseInline idPrefix="gastronomiegeraete" />

            <DeviceFaqSection
              id="haeufige-fragen"
              heading="Häufige Fragen zu Ihren Gastronomiegeräten."
              lead="Welche Geräte wir reparieren, wie schnell wir vor Ort sind und was der Einsatz kostet."
              items={gastroFaqs}
            />
          </div>
        </div>

        <ContactSection headingId="gastronomiegeraete-contact-heading" />

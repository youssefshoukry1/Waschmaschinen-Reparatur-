...
import { dryerFaqs } from "@/lib/trocknerFaq";
...
const heroImage = {
  ...
  alt: "Explosionszeichnung eines Wäschetrockners: Trommel, Flusensieb, Wärmetauscher, Feuchtigkeitsfühler und Steuerelektronik",
};

const title = "Trockner Reparatur Berlin – Notdienst vor Ort";
const description = `Trockner-Reparatur in Berlin und Umland, rund um die Uhr. Anfahrt inklusive Kostenvoranschlag für nur ${business.calloutFee} € – ohne Zuschlag an Wochenenden und Feiertagen. Dazu ${dryerFaqs.length} häufige Fragen und Antworten rund um den Trockner.`;
...
export default function LeistungenPage() {
  ...
  const serviceSchema = {
    ...
    "@type": "Service",
    name: "Trockner Reparatur Notdienst Berlin",
    description,
    url: pageUrl,
    serviceType: "Trockner Reparatur",
    provider: {
      "@type": "LocalBusiness",
      name: business.name,
      url: siteUrl,
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Trockner Reparatur", item: pageUrl },
    ],
  };
  ...
  return (
    <>
      ...
      <main className="page-shell">
        <section className="hero hero--diagram" id="notdienst" aria-labelledby="trockner-heading">
          <svg
          ...
          <div className="hero-inner">
            <div className="hero-content">
              <p className="hero-kicker">Trockner-Reparatur · Berlin &amp; Umland</p>
              <AnimatedPageTitle
                id="trockner-heading"
                parts={[
                  { text: "Trockner Reparatur " },
                  { text: "rund um die Uhr", emphasized: true },
                ]}
              />
              <p className="hero-description">
                Die Wäsche bleibt feucht, das Programm bricht ab oder das Gerät bleibt ganz stehen?
                Flusensieb, Wärmetauscher, Feuchtigkeitsfühler und Heizung prüfen wir direkt bei Ihnen
                zu Hause – bei Kondens-, Ablauf- und Wärmepumpentrocknern.
              </p>
        ...
        <div className="device-faq-layout device-faq-layout--with-why device-faq-layout--rail-match">
          ...
          <div className="device-faq-column">
            <WhyChooseInline idPrefix="trockner" />

            <DeviceFaqSection
              id="haeufige-fragen"
              heading="Häufige Fragen zu Ihrem Trockner."
              lead="Feuchte Wäsche, abgebrochene Programme und die wichtigsten Antworten zu Preis und Termin auf einen Blick."
              items={dryerFaqs}
            />
          </div>
        </div>

        <ContactSection headingId="trockner-contact-heading" />

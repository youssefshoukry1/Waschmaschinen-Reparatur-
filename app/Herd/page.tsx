...
export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "/herd-backofen-reparatur-berlin" },
  openGraph: { title, description, url: "/herd-backofen-reparatur-berlin", locale: "de_DE", type: "website" },
};

export default function LeistungenPage() {
  const pageUrl = `${siteUrl}/herd-backofen-reparatur-berlin`;

...
import { dishwasherFaqs } from "@/lib/spuelmaschineFaq";
...
const heroImage = {
  ...
  alt: "Explosionszeichnung eines Geschirrspülers: Sprüharme, Siebkombination, Umwälzpumpe, Laugenpumpe, Heizung und Türdichtung",
};

const title = "Spülmaschinen Reparatur Berlin – Geschirrspüler Notdienst";
const description = `Geschirrspüler- und Spülmaschinen-Reparatur in Berlin und Umland, rund um die Uhr. Anfahrt inklusive Kostenvoranschlag für nur ${business.calloutFee} € – ohne Zuschlag an Wochenenden und Feiertagen. Dazu ${dishwasherFaqs.length} häufige Fragen und Antworten rund um den Geschirrspüler.`;

export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "/spuelmaschinen-reparatur-berlin" },
  openGraph: { title, description, url: "/spuelmaschinen-reparatur-berlin", locale: "de_DE", type: "website" },
};

export default function LeistungenPage() {
  const pageUrl = `${siteUrl}/spuelmaschinen-reparatur-berlin`;

  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Spülmaschinen Reparatur Notdienst Berlin",
    description,
    url: pageUrl,
    serviceType: "Spülmaschinen Reparatur",
    provider: {
      "@type": "LocalBusiness",
      name: business.name,
      url: siteUrl,
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Spülmaschinen Reparatur", item: pageUrl },
    ],
  };
      ...
      <main className="page-shell">
        <section className="hero hero--diagram" id="notdienst" aria-labelledby="spuelmaschine-heading">
          ...
          <div className="hero-inner">
            <div className="hero-content">
              <p className="hero-kicker">Spülmaschinen-Notdienst · Berlin &amp; Umland</p>
              <AnimatedPageTitle
                id="spuelmaschine-heading"
                parts={[
                  { text: "Spülmaschinen Reparatur " },
                  { text: "rund um die Uhr", emphasized: true },
                ]}
              />
              <p className="hero-description">
                Kein Wasserzulauf, Fehlercode im Display oder Wasser unter dem Gerät? Wir prüfen
                Umwälzpumpe, Laugenpumpe, Heizung und Elektronik direkt bei Ihnen in der Küche.
              </p>
        ...
        <div className="device-faq-layout device-faq-layout--with-why device-faq-layout--rail-match">
          ...
          <div className="device-faq-column">
            <WhyChooseInline idPrefix="afwasmachine" />

            <DeviceFaqSection
              id="haeufige-fragen"
              heading="Häufige Fragen zu Ihrem Geschirrspüler."
        ...
        <ContactSection headingId="spuelmaschine-contact-heading" />

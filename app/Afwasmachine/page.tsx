...
const description = `24-Stunden-Waschmaschinen-Reparatur in Berlin und Umgebung. Technikerbesuch inklusive Kostenvoranschlag für nur ${business.calloutFee} € – ohne Zuschlag an Wochenenden und Feiertagen. Dazu ${dishwasherFaqs.length} häufige Fragen und Antworten rund um den Geschirrspüler.`;
    ...
    <>
      ...
      <main className="page-shell page-shell--brand-rail">
        {/* Klammer fuer die rote Servicespalte: Sie bleibt per `position: sticky`
            stehen, solange dieser Wrapper im Bild ist – also ueber Hero, Mittelteil
            und Kontaktsektion – und laeuft erst mit dem Banner "Selbst geprueft und
        ...
        <div className="rail-layout">
          <div className="rail-layout__main">
            <section className="hero hero--diagram hero--with-rail" id="notdienst" aria-labelledby="spuelmaschine-heading">
              <svg
                ...
                <div className="hero-content">
                  ...
                  <div className="hero-photo">
                    <Image
                      ...
                      fill
                      priority
                      // Ab 1025px zeigt die rote Servicespalte die Zeichnung
                      // und `.hero--with-rail .hero-photo` blendet diese Kopie
                      // aus. Die 1px halten den Browser davon ab, sie dort
                      // trotzdem gross zu laden. Die Zweige darunter bleiben
                      // unveraendert.

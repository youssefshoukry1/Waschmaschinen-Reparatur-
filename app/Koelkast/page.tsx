...
import { fridgeBrands, fridgeFaqs } from "@/lib/kuehlschrankFaq";
...
export default function KuehlschrankPage() {
  ...
  const serviceSchema = {
    ...
    "@type": "Service",
    name: "Kühlschrank Reparatur Notdienst Berlin",
    description,
    url: pageUrl,
    serviceType: "Kühlschrank Reparatur",
    provider: {
      "@type": "LocalBusiness",
      name: business.name,
      url: siteUrl,
    ...
    brand: fridgeBrands.map((name) => ({ "@type": "Brand", name })),
    offers: {
      "@type": "Offer",
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Kühlschrank Reparatur", item: pageUrl },
    ],
  };
      ...
      <main className="page-shell page-shell--brand-rail">
        ...
        <div className="rail-layout">
          <div className="rail-layout__main">
            <section className="hero hero--diagram hero--with-rail" id="notdienst" aria-labelledby="kuehlschrank-heading">
              <svg
              ...
              <div className="hero-inner">
                <div className="hero-content">
                  <p className="hero-kicker">Kühlschrank-Notdienst · Berlin &amp; Umland</p>
                  <AnimatedPageTitle
                    id="kuehlschrank-heading"
                    parts={[
                      { text: "Kühlschrank Reparatur " },
                      { text: "rund um die Uhr", emphasized: true },
                    ]}
                  />
                  <p className="hero-description">
                    Gerät kühlt nicht mehr, vereist oder läuft ohne Pause durch? Wir prüfen Kompressor,
                    Thermostat, Abtauheizung und Türdichtung – bevor Ihre Lebensmittel verderben.
                  </p>
            ...
            <DeviceFaqSection
              id="haeufige-fragen"
              eyebrow="Kühlschrank-Service"
              heading="Häufige Fragen zu Ihrem Kühlschrank."

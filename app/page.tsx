...
export default async function Home() {
  ...
  return (
    <>
          ...
          <div className="hero-content">
            ...
            <div className="hero-actions">
              ...
              {trustSettings.showRating ? (
                <div className="customer-proof" aria-label={`${trustSettings.ratingValue} von 5 Sternen: ${trustSettings.ratingLabel}`}>
                  ...
                  <strong className="google-review__score">
                    {new Intl.NumberFormat("de-DE", { minimumFractionDigits: 1, maximumFractionDigits: 1 }).format(trustSettings.ratingValue)}
                  </strong>
                  <span className="google-review__label">{trustSettings.ratingLabel}</span>
                </div>
              ) : null}
            </div>
      ...
      <section className="booking-banner" aria-labelledby="booking-banner-heading">
        <Image

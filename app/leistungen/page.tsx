      ...
      <main className="page-shell page-shell--brand-rail">
        ...
        <div className="rail-layout">
          <div className="rail-layout__main">
            <section className="hero hero--diagram hero--with-rail" id="notdienst" aria-labelledby="leistungen-heading">
              <svg
              ...
              <div className="hero-inner">
                <div className="hero-content">
                  <p className="hero-kicker">24-Stunden-Notdienst · Berlin &amp; Umland</p>
                  <AnimatedPageTitle
                    id="leistungen-heading"
                    parts={[
                      { text: "Waschmaschinen Reparatur " },
                      { text: "rund um die Uhr", emphasized: true },
                    ]}
                  />
                  <p className="hero-description">
                    Defekt am Abend, in der Nacht oder am Wochenende? Wir sind rund um die Uhr erreichbar
                    und kommen in ganz Berlin und Umgebung zu Ihnen.
                  </p>

...
import { satelliteFaqs } from "@/lib/satellitenanlageFaq";
...
const heroImage = {
  ...
  alt: "Aufbau einer Satellitenanlage: Parabolspiegel, LNB, Koaxkabel, Multischalter, Antennendose und Receiver",
};

const title = "Satellitenanlagen Reparatur Berlin – Ausrichtung & Service";
const description = `Satellitenanlagen-Service in Berlin und Umland: Reparatur, Ausrichtung und Einrichtung, rund um die Uhr. Anfahrt inklusive Kostenvoranschlag für nur ${business.calloutFee} € – ohne Zuschlag an Wochenenden und Feiertagen. Dazu ${satelliteFaqs.length} häufige Fragen und Antworten rund um die Satellitenanlage.`;
...
export default function LeistungenPage() {
  ...
  const serviceSchema = {
    ...
    "@type": "Service",
    name: "Satellitenanlagen Reparatur Notdienst Berlin",
    description,
    url: pageUrl,
    serviceType: "Satellitenanlagen Reparatur",
    provider: {
      "@type": "LocalBusiness",
      name: business.name,
      url: siteUrl,
  ...
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: satelliteFaqs.map((faq) => ({
      "@type": "Question",
      name: faq.question,
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Satellitenanlagen Reparatur", item: pageUrl },
    ],
  };
  ...
  return (
    <>
      ...
      <main className="page-shell">
        <section className="hero hero--diagram" id="notdienst" aria-labelledby="satellitenanlage-heading">
          <svg
          ...
          <div className="hero-inner">
            <div className="hero-content">
              <p className="hero-kicker">Satellitenanlagen · Berlin &amp; Umland</p>
              <AnimatedPageTitle
                id="satellitenanlage-heading"
                parts={[
                  { text: "Satellitenanlage " },
                  { text: "Reparatur & Ausrichtung", emphasized: true },
                ]}
              />
              <p className="hero-description">
                Kein Signal, Klötzchen im Bild oder einzelne Sender fehlen? Wir richten Ihre Schüssel mit
                dem Messgerät neu aus und prüfen LNB, Koaxkabel, Multischalter und Receiver – im
                Einfamilienhaus wie in der Wohnanlage.
              </p>
        ...
        <div className="device-faq-layout device-faq-layout--with-why device-faq-layout--rail-match">
          ...
          <div className="device-faq-column">
            <WhyChooseInline idPrefix="satellitenanlage" />

            <DeviceFaqSection
              id="haeufige-fragen"
              heading="Häufige Fragen zu Ihrer Satellitenanlage."
              lead="Signalausfall, Bildaussetzer und die wichtigsten Antworten zu Preis und Termin auf einen Blick."
              items={satelliteFaqs}
            />
          </div>
        </div>

        <ContactSection headingId="satellitenanlage-contact-heading" />
